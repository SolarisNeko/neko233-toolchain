...
public class HostInfo implements Serializable {
    ...
    public HostInfo() {
        final InetAddress localhost = NetUtils233.getLocalhost();
        if (null != localhost) {
    ...
    public final String toString() {
        ...
        StringUtils233.appendByPrintStyle(builder, "Host Name:    ", getName());
        StringUtils233.appendByPrintStyle(builder, "Host Address: ", getAddress());
