...
public class OsInfo implements Serializable {
    ...
    private final String OS_VERSION = SystemUtils233.get("os.version", false);
    private final String OS_ARCH = SystemUtils233.get("os.arch", false);
    private final String OS_NAME = SystemUtils233.get("os.name", false);
    ...
    // 由于改变 file.encoding 属性并不会改变系统字符编码，为了保持一致，通过 LocaleUtil 取系统默认编码。
    private final String FILE_SEPARATOR = SystemUtils233.get("file.separator", false);
    private final String LINE_SEPARATOR = SystemUtils233.get("line.separator", false);
    private final String PATH_SEPARATOR = SystemUtils233.get("path.separator", false);
    ...
    public final String toString() {
        ...
        builder.append("OS Name:        ").append(getName());
        builder.append("OS Version:     ").append(getVersion());
        builder.append("File Separator: ").append(getFileSeparator());
        builder.append("Line Separator: ").append(getLineSeparator());
        builder.append("Path Separator: ").append(getPathSeparator());
