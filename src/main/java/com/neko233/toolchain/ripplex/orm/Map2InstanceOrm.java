package com.neko233.toolchain.ripplex.orm;

import com.neko233.toolchain.common.base.CollectionUtils233;
import com.neko233.toolchain.common.reflect.ReflectUtils233;
import com.neko233.toolchain.ripplex.strategy.transform.TransformValueStrategy;
...
public class Map2InstanceOrm {
    ...
    public static <T> T orm(Map<String, Object> dataMap, Class<?> schema) {
        List<Field> fieldList = ReflectUtils233.getAllFieldsRecursive(schema);
