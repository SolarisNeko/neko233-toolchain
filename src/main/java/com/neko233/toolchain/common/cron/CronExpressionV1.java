...
public final class CronExpressionV1 implements Serializable, Cloneable {
     ...
     */
    public CronExpressionV1(String cronExpression) throws ParseException {
     ...
     */
    public CronExpressionV1(CronExpressionV1 expression) {
        /*
    ...
    public Date getNextValidTimeAfter() {
        return getNextValidTimeAfter(new Date());
    }
    ...
    public Date getNextInvalidTimeAfter(Date date) {
        ...
        // @modifier SolarisNeko
        // [QUARTZ-481] done. quartz 之前没有重试次数, 会空跑 CPU
        int tryCount = 0;
        while (difference == 1000 && tryCount < 1000) {
    ...
    @Deprecated
    public Object clone() {
        return new CronExpressionV1(this);
    }
}
