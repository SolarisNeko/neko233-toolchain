package com.neko233.toolchain.common.network.mask;

import com.neko233.toolchain.common.dataStruct.maps.BiDirectionalMap;
...
public class MaskBit {
     ...
     * 掩码位与掩码的点分十进制的双向对应关系
     */
    private static final BiDirectionalMap<Integer, String> MASK_BIT_MAP;

    static {
        MASK_BIT_MAP = new BiDirectionalMap<>();
     ...
     * @return 掩码
     */
    public static String getIp(int maskBit) {
        return MASK_BIT_MAP.getForward(maskBit);
    }
    ...
    public static Integer getMaskBit(String mask) {
        return MASK_BIT_MAP.getBack(mask);
    }
