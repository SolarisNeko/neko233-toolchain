...
public class AssertUtils233 {
    ...
    public static void hasLength(@Nullable String text, String message) {
        if (!StringUtils233.isNotBlank(text)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void doesNotContain(@Nullable String textToSearch, String substring, String message) {
        if (StringUtils233.isNotBlank(textToSearch) && StringUtils233.isNotBlank(substring) && textToSearch.contains(substring)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    private static void instanceCheckFailed(Class<?> type, @Nullable Object obj, @Nullable String msg) {
        ...
        if (StringUtils233.isNotBlank(msg)) {
    ...
    public static void isNotBlank(String content) {
        isNotBlank(content, "your content is blank! please check. value = " + content);
    }

    public static void isNotBlank(String content, String msg) {
