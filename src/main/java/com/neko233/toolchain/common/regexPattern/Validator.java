...
public class Validator {
    ...
    public static boolean isEmpty(Object value) {
        return (null == value || (value instanceof String && StringUtils233.isEmpty((String) value)));
    }
    ...
    public static boolean isMatchRegex(Pattern pattern, CharSequence value) {
        return RegexUtils233.isMatch(pattern, value);
    }
    ...
    public static boolean isMatchRegex(String regex, CharSequence value) {
        return RegexUtils233.isMatch(regex, value);
    }
    ...
    public static boolean isLetter(CharSequence value) {
        return RegexUtils233.isAllCharMatch(value, Character::isLetter);
    }
    ...
    public static boolean isUpperCase(CharSequence value) {
        return RegexUtils233.isAllCharMatch(value, Character::isUpperCase);
    }
    ...
    public static boolean isLowerCase(CharSequence value) {
        return RegexUtils233.isAllCharMatch(value, Character::isLowerCase);
    }
    ...
    public static boolean isNumber(CharSequence value) {
        return MathUtils233.isNumber(value);
    }
    ...
    public static boolean hasNumber(CharSequence value) {
        return RegexUtils233.contains(PatternPool.NUMBERS, value);
    }
    ...
    public static boolean isBirthday(int year, int month, int day) {
        ...
        if (month == 2) {
            // 在2月，非闰年最大28，闰年最大29
            return day < 29 || (day == 29 && DateTimeUtils233.isLeapYear(year));
        }
        return true;
    }
    ...
    public static boolean isUrl(CharSequence value) {
        ...
        try {
            new java.net.URL(StringUtils233.stringIfNull(value));
    ...
    public static boolean hasChinese(CharSequence value) {
        return RegexUtils233.contains(RegexUtils233.RE_CHINESES, value);
    }
    ...
    public static boolean isBetween(Number value, Number min, Number max) {
        if (ObjectUtils233.isAnyNull(value, min, max)) {
            throw new IllegalArgumentException(StringUtils233.format("can't not be null! {}, {}, {}", value, min, max));
        }
